...
class BlogPost extends Model
{
    ...
    /**
     * Posts belonging to a given WEBI app namespace (e.g. leadform, ordersheet).
     *
     * @param  Builder<static>  $query
     * @return Builder<static>
     */
    public function scopeForApp(Builder $query, string $appSlug): Builder
    {
        return $query->where('app_slug', $appSlug);
    }
