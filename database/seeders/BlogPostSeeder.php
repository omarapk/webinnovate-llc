...
MD),
        ...
        BlogPost::firstOrCreate(['slug' => 'cash-on-delivery-mena-africa-shopify-guide'], [
            'title' => 'Cash on Delivery in MENA & Africa: The Complete Guide for Shopify Merchants (2025)',
            'author_name' => 'LeadForm Team',
            'status' => 'published',
            'published_at' => '2025-04-28',
            'excerpt' => 'COD dominates ecommerce in MENA and Africa — over 70% of orders in Egypt, 60%+ across the region. This guide covers everything Shopify merchants need to set up, manage, and scale a profitable COD operation.',
            'content' => $this->mdToHtml(<<<'MD'
...
MD),
            'alt_text' => 'Cash on delivery guide for MENA and Africa Shopify merchants 2025',
            'seo_title' => 'Cash on Delivery in MENA & Africa: Shopify Guide (2025)',
            'meta_description' => 'COD dominates ecommerce in MENA and Africa. This complete guide covers how to set it up right on Shopify, reduce returns, and scale profitably in these markets.',
            'tags' => ['COD', 'MENA', 'Africa', 'Shopify', 'ecommerce', 'Morocco', 'Egypt', 'dropshipping'],
            'featured_image' => null,
        ]);

        BlogPost::firstOrCreate(['slug' => 'cod-order-form-best-practices'], [
            'title' => 'COD Order Form Best Practices: The Fields That Reduce Returns and Boost Delivery Rates',
            'author_name' => 'LeadForm Team',
            'status' => 'published',
            'published_at' => '2025-05-05',
            'excerpt' => 'Most COD merchants use the wrong form fields — and it\'s costing them in returns and failed deliveries. Here\'s exactly what to include, what to remove, and why each decision directly impacts your bottom line.',
            'content' => $this->mdToHtml(<<<'MD'
...
MD),
            'alt_text' => 'COD order form best practices — fields that reduce returns and improve delivery rates',
            'seo_title' => 'COD Order Form Best Practices: Fields That Reduce Returns',
            'meta_description' => 'Most merchants use the wrong form fields for COD orders. Here\'s exactly what to ask — and what to remove — to get more confirmed, real deliveries.',
            'tags' => ['COD', 'order form', 'RTO', 'delivery rate', 'Shopify', 'form optimization', 'mobile'],
            'featured_image' => null,
        ]);

        BlogPost::firstOrCreate(['slug' => 'convert-cod-customers-prepaid-shopify'], [
            'title' => 'How to Convert COD Customers to Prepaid (Without Pushing Them Away)',
            'author_name' => 'LeadForm Team',
            'status' => 'published',
            'published_at' => '2025-05-12',
            'excerpt' => 'COD is how your customers buy. Prepaid is how you scale. Here\'s a step-by-step strategy to nudge your best COD buyers toward prepaid — without friction, without pressure, and without losing them.',
            'content' => $this->mdToHtml(<<<'MD'
...
MD),
            'alt_text' => 'How to convert COD customers to prepaid on Shopify — step by step strategy',
            'seo_title' => 'How to Convert COD Customers to Prepaid on Shopify',
            'meta_description' => 'COD is how your customers buy. Prepaid is how you scale. Here\'s a proven 3-stage strategy to shift your COD buyers toward prepaid — without pushing them away.',
            'tags' => ['COD', 'prepaid', 'conversion', 'Shopify', 'retention', 'ecommerce strategy', 'MENA'],
            'featured_image' => null,
        ]);
    }
}
